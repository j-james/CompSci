...
public class Magpie3_JAMES {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "chase") != -1) {
			response = "Never heard of him.";
		}
		else if (findKeyword(statement, "panda") != -1){
			response = "Pandas are my favorite animal. What is yours?";
		}
		else if (findKeyword(statement, "turner") != -1){
			response = "He sounds like a good teacher.";
		}
		else if (findKeyword(statement, "magpie") != -1){
			response = "Magpie? The bird?";
		}
		else if ((findKeyword(statement, "dog") != -1) || (findKeyword(statement, "cat") != -1)) {
			response = "What is your pet's name?";
		}
		else if (findKeyword(statement, "tommy jeans") != -1) {
			response = "what";
		}
		else if (findKeyword(statement, "apricot") != -1) {
